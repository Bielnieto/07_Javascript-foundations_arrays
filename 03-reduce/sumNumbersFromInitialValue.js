...
export default function sumNumbersFromInitialValue(numbersList, initialAccumulatedValue) {
    return numbersList.reduce((sum, number) => sum + number, initialAccumulatedValue);
  }
